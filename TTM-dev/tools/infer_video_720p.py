...
if __name__ == '__main__':
    ...
    base_dir='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtsearch-assistant/ai-search/dongchengqi/InfinityStar/Fast/TTM-dev'
    ...
    for idx, prompt in enumerate(prompts):
        ...
        save_dir = f'{base_dir}/visual/raw'#new_{args.mode}
    ...
    cal_vis_metric(f'{base_dir}/visual/raw', save_dir)
