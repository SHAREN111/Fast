...
if __name__ == '__main__':
    ...
    checkpoints_dir = '/data3/chengqidong/mrg/InfinityStar/save/pth'
    ...
    for idx, prompt in enumerate(prompts):
        ...
        save_dir = '/data3/chengqidong/mrg/InfinityStar/visual'
        gen_video_path = osp.join(os.path.join(save_dir, 'raw_videos'), f'demo{idx}_{generation_duration}.mp4')
